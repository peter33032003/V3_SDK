...
export enum EAPI
{
    ...
    EAPI_ID_AONCUS_HISAFE_SIOCOUNT = 6,
 ...
 */
const ApiConfig = {
    EApiBoardGetStringA: ["UInt32", ["UInt32", CharPtr, "UInt32"]],
    EApiBoardGetValue: ["UInt32", ["UInt32", IntPtr]],
    EApiHWMONGetCaps: ["UInt32", ["UInt32", uIntPtr, uIntPtr, uIntPtr]],
    EApiLibInitialize: ["UInt32", []],
    EApiLibUnInitialize: ["UInt32", []],
    EApiGPIOGetCaps: ['UInt32', ['UInt32', uIntPtr, uIntPtr]],
    EApiGPIOGetDirection: ['UInt32', ['UInt32', 'UInt32', uIntPtr]],
    EApiGPIOGetLevel: ['UInt32', ['UInt32', 'UInt32', uIntPtr]],
    EApiGPIOSetDirection: ['UInt32', ['UInt32', 'UInt32', 'UInt32']],
    EApiGPIOSetLevel: ['UInt32', ['UInt32', 'UInt32', 'UInt32']],
    EApiSfanGetStatus: ["UInt32", ["UInt32", IntPtr, IntPtr, IntPtr, IntPtr]],
    EApiSfanSetStatus: ["UInt32", ["UInt32", "int", "int", "int", "int"]],
    EApiSfanGetCaps: ["UInt32", ["UInt32", IntPtr]],
    EApiSfanGetControlPoints: ["UInt32", ["UInt32", IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr]],
    EApiSfanSetControlPoints: ["UInt32", ["UInt32", "int", "int", "int"]],
    EApiSfanDetectTemperaturePoints: ["UInt32", ["UInt32", uIntPtr]],
    ...
    EApiWDogGetCap: ['UInt32', [uIntPtr, uIntPtr, uIntPtr]],
    EApiWDogStart: ['UInt32', ['UInt32', 'UInt32', 'UInt32', 'UInt32']],
    EApiWDogSetStatus: ['UInt32', ['int', 'int', 'int']],
    EApiWDogGetStatus: ['UInt32', [IntPtr, IntPtr, IntPtr]],
    EApiWDogStop: ['Uint32', []],
    EApiWDogReloadTimer: ['Uint32', []],
    EApiBKLIGHTGetCaps: ["UInt32", [uIntPtr]],
    EApiVGALibInitialize: ['Uint32', []],
    EApiVGALibUnInitialize: ['Uint32', []],
    EApiVgaSetBacklightBrightness: ["UInt32", ["UInt32", "UInt32"]],
    EApiVgaGetBacklightBrightness: ["UInt32", ["Uint32", uIntPtr]],
};
